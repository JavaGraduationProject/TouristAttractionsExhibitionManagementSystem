...
public class CartInfoController {
    ...
    @GetMapping("/gentuan")
    public Result<List<GtOrderInfo>> gentuan(@RequestParam("userId") Long userId,
                                             @RequestParam("level") Integer level) {
        return Result.success(gtOrderInfoDao.findOwnGentuan(userId, level));
    }
